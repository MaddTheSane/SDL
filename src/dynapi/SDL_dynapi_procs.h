...
SDL_DYNAPI_PROC(Uint32,SDL_WasInit,(SDL_InitFlags a),(a),return)
...
SDL_DYNAPI_PROC(SDL_AudioDeviceID,SDL_OpenAudioDevice,(const char *a, int b, const SDL_AudioSpec *c, SDL_AudioSpec *d, SDL_AudioAllowedChanges e),(a,b,c,d,e),return)
...
SDL_DYNAPI_PROC(int,SDL_PeepEvents,(SDL_Event *a, int b, SDL_eventaction c, SDL_EventType d, SDL_EventType e),(a,b,c,d,e),return)
SDL_DYNAPI_PROC(SDL_bool,SDL_HasEvent,(SDL_EventType a),(a),return)
SDL_DYNAPI_PROC(SDL_bool,SDL_HasEvents,(SDL_EventType a, SDL_EventType b),(a,b),return)
SDL_DYNAPI_PROC(void,SDL_FlushEvent,(SDL_EventType a),(a),)
SDL_DYNAPI_PROC(void,SDL_FlushEvents,(SDL_EventType a, SDL_EventType b),(a,b),)
...
SDL_DYNAPI_PROC(Uint8,SDL_EventState,(SDL_EventType a, int b),(a,b),return)
